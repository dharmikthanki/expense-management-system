                ...
                <div class="card">
                    ...
                    <form action="" method="post">
								<div>
									...
									<input class="text-input" type="datetime-local" value="" name="dateexpense" pattern="[A-Za-z]" title="Only alphabets are allowed to be entered" required="true" style="width: 100%; padding-top: 8px; "><br><br>
								</div>
								<div>
